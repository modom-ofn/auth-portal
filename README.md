...
[![Go Version](https://img.shields.io/badge/Go-1.26.4%2B-00ADD8?logo=go)](https://go.dev/)
...
- Go: `1.26.4` on Docker Hardened Images `dhi.io/golang:1.26.4-alpine3.23-dev` (builder stage).
...
- Builder: `dhi.io/golang:1.26.4-alpine3.23-dev`.
